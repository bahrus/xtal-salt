...
<img src="http://img.badgesize.io/https://unpkg.com/xtal-salt@0.0.4/dist/xtal-salt.iife.min.js?compression=gzip">
...
<template>
    <div>
        ...
        <p-d on="load" to="xtal-salt" prop="xmlString" val="target.innerHTML"></p-d>
        <template>
        ...
        <script type="module" src="https://cdn.jsdelivr.net/npm/xtal-salt@0.0.2/dist/xtal-salt.iife.js"></script>
